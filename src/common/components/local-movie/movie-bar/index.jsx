                ...
                <div className="w-full h-[450px]">
                    <div className="w-full h-full flex space-x-4">
                        <div className="w-[35%] h-full">
                            <img className="w-full h-full rounded-xl object-cover pointer-events-none" src={movieData.backdrop_path === null || movieData.backdrop_path === undefined ? `/media/images/noPic.png` : `${process.env.REACT_APP_IMG_HOST}${movieData.backdrop_path}`} alt="movie" />
                        </div>

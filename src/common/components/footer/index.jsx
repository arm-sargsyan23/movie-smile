        ...
        <footer className="h-[120px] w-full flex justify-center items-end">
            <div className="w-full h-full px-20 py-8 backdrop-blur-2xl flex items-center justify-between ">
                <div className="flex space-x-4">
                    ...
                    <a className="w-[30px] transition ease-in hover:scale-[1.2]" href="https://www.facebook.com/">
                        <img src="/media/images/facebook.png" alt="Facebook Icon" />
                    </a>
                    <a className="w-[30px] transition ease-in hover:scale-[1.2]" href="https://www.whatsapp.com/?lang=ru_RU">
                        <img src="/media/images/whatsapp.png" alt="Whatsapp Icon" />
                    </a>
                    <a className="w-[30px] transition ease-in hover:scale-[1.2]" href="https://www.instagram.com/">
                        <img src="/media/images/instagram.png" alt="Instagram Icon" />
                    </a>
                    <a className="w-[30px] transition ease-in hover:scale-[1.2]" href="https://www.messenger.com/?locale=ru_RU">
                        <img src="/media/images/facebook-messenger.png" alt="Messeger Icon" />
                    </a>
                    <a className="w-[30px] transition ease-in hover:scale-[1.2]" href="https://www.youtube.com/watch?v=U-aO-G6jEYc">
